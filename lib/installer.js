...
export async function install(opts) {
  ...
  // Core hooks (exclude superkit-internal hooks that only work in superkit repo)
  const SUPERKIT_INTERNAL_HOOKS = ['superkit-counts-verify.sh', 'verify-hooks.sh'];
  ...
  const SUPERKIT_INTERNAL_RULES = ['superkit-integrity.md'];
