...
packages/
  core/                     # Generic components (any project)
    ...
    hooks/                  # 20 hooks (+2 superkit-internal) = 22 total · incl. /dev trio, audit-settings-source, audit-trail, plan-completion-gate, user-intent-detect
