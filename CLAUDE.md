...
packages/
  core/                     # Generic components (any project)
    ...
    hooks/                  # 19 hooks (+2 superkit-internal) = 21 total · incl. /dev enforcement trio + audit-settings-source (CVE-2025-59536) + audit-trail (hash-chained log) + plan-completion-gate
