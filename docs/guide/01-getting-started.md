...
| `/dev <task>` | Full 16-phase orchestrator: read-docs, understand, architect, pseudocode, plan, contract, validate, implement, evaluate, verify, test, goals, review, critic, document, report |
